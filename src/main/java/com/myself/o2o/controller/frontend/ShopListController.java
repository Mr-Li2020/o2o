...
import com.myself.o2o.service.AreaService;
import com.myself.o2o.service.ShopCategoryService;
...
public class ShopListController {
    ...
    /**
     * 返回商品列表页面的ShopCategory列表(二级或者一级) 以及区域信息列表
     * @param request
     * @return
     */
    ...
    private Map<String,Object> listShopPageInfo(HttpServletRequest request){
        ...
        if(parentId != -1){
            ...
            try{
                //如果parentId不存在,则取出所有以及ShopCategory(用过户在首页选择的是全部商店列表)
